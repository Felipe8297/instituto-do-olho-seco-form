...
const ESCALA_FREQ: Option[] = [
  // p8–p17 (botões)
  { label: "Tempo todo", points: 4 },
  { label: "Maior parte do tempo", points: 3 },
  { label: "Metade do tempo", points: 2 },
  { label: "Alguns momentos", points: 1 },
  { label: "Nenhum momento", points: 0 },
];
...
const ESCALA_FREQ2: Option[] = [
  ...
  { label: "Frequente", points: 3 },
  { label: "Constante", points: 4 },
];
...
export const QUESTIONS: Question[] = [
  ...
  { id: "p9", text: "Sensação de areia nos olhos?", view: "botoes", multi: false, options: ESCALA_FREQ },
  { id: "p10", text: "Dor ou irritação nos olhos?", view: "botoes", multi: false, options: ESCALA_FREQ },
  {
    id: "p11",
...
export const SCORE_MAX_ESCALA = 60;

// Marcadores das faixas desenhados na régua do termômetro.
export const BAND_TICKS = [20, 30, 40];
